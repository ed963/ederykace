...
if __name__ == '__main__':
    ...
    search_term_escaped = urllib.parse.quote(search_term)

    response = urllib.request.urlopen(f"https://api.urbandictionary.com/v0/define?term={search_term_escaped}").read()
